...
// const Hero = () => {
//   return (
//     <section className="flex justify-center items-center bg-blue-600 text-white py-20">
//       <Video src={EcomVideo}/>
//       <div className="text-center space-y-4">
//         <h1 className="text-4xl font-bold">Welcome to Our Shop!</h1>
//         <p className="text-xl">Find the best products here.</p>
//       </div>
//     </section>
//   );
// };
...
<p className="text-lg md:text-xl italic bg-gradient-radial from-red-400 via-black to-white bg-clip-text text-transparent animate-gradient">
  Find the best <span className="font-bold underline decoration-wavy text-white-300">products</span> here.
</p>
